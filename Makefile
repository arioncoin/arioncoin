...
pkgdatadir = $(datadir)/arioncore
pkgincludedir = $(includedir)/arioncore
pkglibdir = $(libdir)/arioncore
pkglibexecdir = $(libexecdir)/arioncore
...
CONFIG_HEADER = $(top_builddir)/src/config/arion-config.h
CONFIG_CLEAN_FILES = libarionconsensus.pc share/setup.nsi \
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	$(srcdir)/libarionconsensus.pc.in \
	...
	$(top_srcdir)/src/config/arion-config.h.in \
...
ACLOCAL = ${SHELL} /Users/martinmizzell/repos/arioncoin/build-aux/missing aclocal-1.16
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /Users/martinmizzell/repos/arioncoin/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /Users/martinmizzell/repos/arioncoin/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /Users/martinmizzell/repos/arioncoin/build-aux/missing automake-1.16
AWK = awk
...
CXXFLAGS = -g -O2 -Wall -Wextra -Wformat -Wformat-security -Wno-unused-parameter -Wno-self-assign -Wno-unused-local-typedef -Wno-deprecated-register -Wno-implicit-fallthrough
CYGPATH_W = echo
DEFS = -DHAVE_CONFIG_H
DEPDIR = .deps
DLLTOOL = false
...
MAINT = 
MAKEINFO = ${SHELL} /Users/martinmizzell/repos/arioncoin/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OBJCXXFLAGS = -g -O2 -Wall -Wextra -Wformat -Wformat-security -Wno-unused-parameter -Wno-self-assign -Wno-unused-local-typedef -Wno-deprecated-register -Wno-implicit-fallthrough
OBJDUMP = objdump
OBJEXT = o
OTOOL = otool
OTOOL64 = :
PACKAGE = arioncore
PACKAGE_BUGREPORT = https://github.com/ArionCore/Arion/issues
PACKAGE_NAME = Arion Core
PACKAGE_STRING = Arion Core 1.1.5
PACKAGE_TARNAME = arioncore
PACKAGE_URL = 
...
abs_builddir = /Users/martinmizzell/repos/arioncoin
abs_srcdir = /Users/martinmizzell/repos/arioncoin
abs_top_builddir = /Users/martinmizzell/repos/arioncoin
abs_top_srcdir = /Users/martinmizzell/repos/arioncoin
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /Users/martinmizzell/repos/arioncoin/build-aux/install-sh
...
pkgconfig_DATA = libarionconsensus.pc
BITCOIND_BIN = $(top_builddir)/src/ariond$(EXEEXT)
BITCOIN_QT_BIN = $(top_builddir)/src/qt/arion-qt$(EXEEXT)
BITCOIN_CLI_BIN = $(top_builddir)/src/arion-cli$(EXEEXT)
BITCOIN_WIN_INSTALLER = $(PACKAGE)-$(PACKAGE_VERSION)-win$(WINDOWS_BITS)-setup$(EXEEXT)
OSX_APP = Arion-Qt.app
OSX_DMG = Arion-Core.dmg
...
COVERAGE_INFO = baseline_filtered_combined.info baseline.info block_test.info \
  leveldb_baseline.info test_arion_filtered.info total_coverage.info \
  baseline_filtered.info block_test_filtered.info rpc_test.info rpc_test_filtered.info \
  leveldb_baseline_filtered.info test_arion_coverage.info test_arion.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/bitcoin.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/Arion-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
src/config/arion-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/arion-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/arion-config.h
$(top_srcdir)/src/config/arion-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/arion-config.h src/config/stamp-h1
libarionconsensus.pc: $(top_builddir)/config.status $(srcdir)/libarionconsensus.pc.in
...
$(OSX_APP)/Contents/MacOS/Arion-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
#$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Arion-Qt

#$(OSX_DMG): $(APP_DIST_EXTRAS)
#	$(GENISOIMAGE) -no-cache-inodes -D -l -probe -V "Arion-Core" -no-pad -r -dir-mode 0755 -apple -o $@ dist
...
#$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Arion-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#test_arion.info: baseline_filtered_combined.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c -d $(abs_builddir)/src -t test_arion -o $@
#	$(LCOV) -z -d $(abs_builddir)/src
#	$(LCOV) -z -d $(abs_builddir)/src/leveldb

#test_arion_filtered.info: test_arion.info
#	$(LCOV) -r $< "/usr/include/*" -o $@

#block_test.info: test_arion_filtered.info
#	$(MKDIR_P) qa/tmp
...
#rpc_test.info: test_arion_filtered.info
...
#test_arion_coverage.info: baseline_filtered_combined.info test_arion_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_arion_filtered.info -o $@

#total_coverage.info: baseline_filtered_combined.info test_arion_filtered.info block_test_filtered.info rpc_test_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_arion_filtered.info -a block_test_filtered.info -a rpc_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_arion.coverage/.dirstamp:  test_arion_coverage.info
#	$(GENHTML) -s $< -o $(@D)
#	@touch $@
...
#cov: test_arion.coverage/.dirstamp total.coverage/.dirstamp

# Arion: disable the test until upstream switches from convoluted comparison tool
...
clean-local:
	rm -rf coverage_percent.txt test_arion.coverage/ total.coverage/ qa/tmp/ cache/ $(OSX_APP)
