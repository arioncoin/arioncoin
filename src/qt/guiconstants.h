...
/* ArionGUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Arion"
#define QAPP_ORG_DOMAIN "arion.org"
#define QAPP_APP_NAME_DEFAULT "Arion-Qt"
#define QAPP_APP_NAME_TESTNET "Arion-Qt-testnet"
