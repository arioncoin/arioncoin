    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Arion Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Arion address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and arion: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Arion Core"), this);
    aboutAction->setStatusTip(tr("Show information about Arion Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Arion Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Arion addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Arion addresses"));
    ...
    openAction->setStatusTip(tr("Open a arion: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Arion Core help message to get a list with possible Arion Core command-line options"));
...
void BitcoinGUI::createToolBars()
{
    ...
    if(walletFrame)
    {
        ...
        QPixmap raplogopix (QString::fromUtf8(":/images/light/arion_logo_header"));
        srand(std::time(0));
        ...
        // Make it sparkle
        if (randart == 1){
             raplogopix=(QString::fromUtf8(":/images/light/arion_logo_header_b"));
        } else if (randart == 2){
             raplogopix=(QString::fromUtf8(":/images/light/arion_logo_header_c"));
        } else if (randart == 3){
             raplogopix=(QString::fromUtf8(":/images/light/arion_logo_header_d"));
        } else if (randart == 4){
             raplogopix=(QString::fromUtf8(":/images/light/arion_logo_header_e"));
        } else if (randart == 5){
             raplogopix=(QString::fromUtf8(":/images/light/arion_logo_header_f"));
        } else if (randart == 6){
             raplogopix=(QString::fromUtf8(":/images/light/arion_logo_header_g"));
        } else if (randart == 7){
             raplogopix=(QString::fromUtf8(":/images/light/arion_logo_header_h"));
        } else if (randart == 8){
             raplogopix=(QString::fromUtf8(":/images/light/arion_logo_header_i"));
        } else if (randart == 9){
             raplogopix=(QString::fromUtf8(":/images/light/arion_logo_header"));
        } else if (randart == 10){
             raplogopix=(QString::fromUtf8(":/images/light/arion_logo_header_g"));
        }
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Arion Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("Arion Core"); // default title
