    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Arion Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Arion Core"));
...
All the Arion in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 ARION, 0.1 ARION, 1 ARION and 10 ARION -- sort of like the paper money you use every day.</li> \
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Arion Core is shutting down...") + "<br /><br />" +
