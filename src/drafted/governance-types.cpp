...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "ArionNetwork") type = ArionNetwork;
    if(strType == "ArionNetworkVariable") type = ArionNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == ArionNetwork) s = "ArionNetwork";
    if(type == ArionNetworkVariable) s = "ArionNetworkVariable";
