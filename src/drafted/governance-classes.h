 ...
 *
 *   // network
 *   CArionNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.arion.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CArionNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: ArionNetwork
// //   -- signature requirements : Key1(User)
// class CArionNetworkVariable : public CGovernanceObject
// {
// private:
