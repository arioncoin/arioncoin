...
UniValue getinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total arion balance of the wallet\n"
            "  \"privatesend_balance\": xxxxxx, (numeric) the anonymized arion balance of the wallet\n"
...
UniValue debug(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "arion|privatesend|instantsend|masternode|spork|keepass|mnpayments|gobject )\n"
            "Change debug category on the fly. Specify single category or use comma to specify many.\n"
            "\nExamples:\n"
            + HelpExampleCli("debug", "arion")
            + HelpExampleRpc("debug", "arion,net")
        );
...
UniValue validateaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "\nReturn information about the given arion address.\n"
            "\nArguments:\n"
            "1. \"arionaddress\"     (string, required) The arion address to validate\n"
            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,       (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"arionaddress\", (string) The arion address validated\n"
            ...
            "}\n"
            "\nExamples:\n"
            + HelpExampleCli("validateaddress", "\"AJw5Dqdh47muwzqN1tsmhAiFrvoKqCpna8\"")
            + HelpExampleRpc("validateaddress", "\"AJw5Dqdh47muwzqN1tsmhAiFrvoKqCpna8\"")
        );
...
#ifdef ENABLE_WALLET
        // Case 1: Arion address and we have full public key:
...
UniValue createmultisig(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 2)
    {
        string msg = "createmultisig nrequired [\"key\",...]\n"
            ...
            "2. \"keys\"       (string, required) A json array of keys which are arion addresses or hex-encoded public keys\n"
            "     [\n"
            "       \"key\"    (string) arion address or hex-encoded public key\n"
            "       ,...\n"
            "     ]\n"
...
UniValue verifymessage(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            ...
            "\nArguments:\n"
            "1. \"arionaddress\"  (string, required) The arion address to use for the signature.\n"
            ...
            "\nAs json rpc\n"
            + HelpExampleRpc("verifymessage", "\"AJw5Dqdh47muwzqN1tsmhAiFrvoKqCpna8\", \"signature\", \"my message\"")
        );
...
UniValue getaddressmempool(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressmempool", "'{\"addresses\": [\"AJw5Dqdh47muwzqN1tsmhAiFrvoKqCpna8\"]}'")
            + HelpExampleRpc("getaddressmempool", "{\"addresses\": [\"AJw5Dqdh47muwzqN1tsmhAiFrvoKqCpna8\"]}")
        );
...
UniValue getaddressutxos(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressutxos", "'{\"addresses\": [\"AJw5Dqdh47muwzqN1tsmhAiFrvoKqCpna8\"]}'")
            + HelpExampleRpc("getaddressutxos", "{\"addresses\": [\"AJw5Dqdh47muwzqN1tsmhAiFrvoKqCpna8\"]}")
        );
...
UniValue getaddressdeltas(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1 || !params[0].isObject())
        throw runtime_error(
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressdeltas", "'{\"addresses\": [\"AJw5Dqdh47muwzqN1tsmhAiFrvoKqCpna8\"]}'")
            + HelpExampleRpc("getaddressdeltas", "{\"addresses\": [\"AJw5Dqdh47muwzqN1tsmhAiFrvoKqCpna8\"]}")
        );
...
UniValue getaddressbalance(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "}\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressbalance", "'{\"addresses\": [\"AJw5Dqdh47muwzqN1tsmhAiFrvoKqCpna8\"]}'")
            + HelpExampleRpc("getaddressbalance", "{\"addresses\": [\"AJw5Dqdh47muwzqN1tsmhAiFrvoKqCpna8\"]}")
        );
...
UniValue getaddresstxids(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddresstxids", "'{\"addresses\": [\"AJw5Dqdh47muwzqN1tsmhAiFrvoKqCpna8\"]}'")
            + HelpExampleRpc("getaddresstxids", "{\"addresses\": [\"AJw5Dqdh47muwzqN1tsmhAiFrvoKqCpna8\"]}")
        );
