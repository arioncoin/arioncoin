...
UniValue getnewaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "\nResult:\n"
            "\"arionaddress\"    (string) The new arion address\n"
            "\nExamples:\n"
...
UniValue getaccountaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "\nDEPRECATED. Returns the current Arion address for receiving payments to this account.\n"
            "\nArguments:\n"
...
UniValue getrawchangeaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "getrawchangeaddress\n"
            "\nReturns a new Arion address, for receiving change.\n"
...
UniValue setaccount(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("setaccount", "\"AJw5Dqdh47muwzqN1tsmhAiFrvoKqCpna8\" \"tabby\"")
            + HelpExampleRpc("setaccount", "\"AJw5Dqdh47muwzqN1tsmhAiFrvoKqCpna8\", \"tabby\"")
        );
...
UniValue getaccount(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("getaccount", "\"AJw5Dqdh47muwzqN1tsmhAiFrvoKqCpna8\"")
            + HelpExampleRpc("getaccount", "\"AJw5Dqdh47muwzqN1tsmhAiFrvoKqCpna8\"")
        );
...
UniValue sendtoaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 2 || params.size() > 7)
        throw runtime_error(
            "sendtoaddress \"arionaddress\" amount ( \"comment\" \"comment-to\" subtractfeefromamount use_is use_ps )\n"
            ...
            "                             The recipient will receive less amount of Arion than you enter in the amount field.\n"
            ...
            "\nExamples:\n"
            + HelpExampleCli("sendtoaddress", "\"AJw5Dqdh47muwzqN1tsmhAiFrvoKqCpna8\" 0.1")
            + HelpExampleCli("sendtoaddress", "\"AJw5Dqdh47muwzqN1tsmhAiFrvoKqCpna8\" 0.1 \"donation\" \"seans outpost\"")
            + HelpExampleCli("sendtoaddress", "\"AJw5Dqdh47muwzqN1tsmhAiFrvoKqCpna8\" 0.1 \"\" \"\" true")
            + HelpExampleRpc("sendtoaddress", "\"AJw5Dqdh47muwzqN1tsmhAiFrvoKqCpna8\", 0.1, \"donation\", \"seans outpost\"")
        );
...
UniValue instantsendtoaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 2 || params.size() > 5)
        throw runtime_error(
            "instantsendtoaddress \"arionaddress\" amount ( \"comment\" \"comment-to\" subtractfeefromamount )\n"
            ...
            "\"transactionid\"  (string) The transaction id.\n"
            "\nExamples:\n"
            + HelpExampleCli("instantsendtoaddress", "\"AJw5Dqdh47muwzqN1tsmhAiFrvoKqCpna8\" 0.1")
            + HelpExampleCli("instantsendtoaddress", "\"AJw5Dqdh47muwzqN1tsmhAiFrvoKqCpna8\" 0.1 \"donation\" \"seans outpost\"")
            + HelpExampleCli("instantsendtoaddress", "\"AJw5Dqdh47muwzqN1tsmhAiFrvoKqCpna8\" 0.1 \"\" \"\" true")
            + HelpExampleRpc("instantsendtoaddress", "\"AJw5Dqdh47muwzqN1tsmhAiFrvoKqCpna8\", 0.1, \"donation\", \"seans outpost\"")
        );
...
UniValue signmessage(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 2)
        throw runtime_error(
            ...
            + HelpExampleCli("signmessage", "\"AJw5Dqdh47muwzqN1tsmhAiFrvoKqCpna8\" \"my message\"") +
            "\nVerify the signature\n"
            + HelpExampleCli("verifymessage", "\"AJw5Dqdh47muwzqN1tsmhAiFrvoKqCpna8\" \"signature\" \"my message\"") +
            "\nAs json rpc\n"
            + HelpExampleRpc("signmessage", "\"AJw5Dqdh47muwzqN1tsmhAiFrvoKqCpna8\", \"my message\"")
        );
...
UniValue getreceivedbyaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 1 || params.size() > 3)
        throw runtime_error(
            "getreceivedbyaddress \"arionaddress\" ( minconf addlockconf )\n"
            "\nReturns the total amount received by the given arionaddress in transactions with specified minimum number of confirmations.\n"
            "\nArguments:\n"
            ...
            + HelpExampleCli("getreceivedbyaddress", "\"AJw5Dqdh47muwzqN1tsmhAiFrvoKqCpna8\"") +
            "\nThe amount including unconfirmed transactions, zero confirmations\n"
            + HelpExampleCli("getreceivedbyaddress", "\"AJw5Dqdh47muwzqN1tsmhAiFrvoKqCpna8\" 0") +
            "\nThe amount with at least 6 confirmation, very safe\n"
            + HelpExampleCli("getreceivedbyaddress", "\"AJw5Dqdh47muwzqN1tsmhAiFrvoKqCpna8\" 6") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("getreceivedbyaddress", "\"AJw5Dqdh47muwzqN1tsmhAiFrvoKqCpna8\", 6")
       );
...
UniValue sendfrom(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 3 || params.size() > 7)
        throw runtime_error(
            "sendfrom \"fromaccount\" \"toarionaddress\" amount ( minconf addlockconf \"comment\" \"comment-to\" )\n"
            "\nDEPRECATED (use sendtoaddress). Sent an amount from an account to a arion address."
            + HelpRequiringPassphrase() + "\n"
            "\nArguments:\n"
            ...
            + HelpExampleCli("sendfrom", "\"\" \"AJw5Dqdh47muwzqN1tsmhAiFrvoKqCpna8\" 0.01") +
            "\nSend 0.01 from the tabby account to the given address, funds must have at least 6 confirmations\n"
            + HelpExampleCli("sendfrom", "\"tabby\" \"AJw5Dqdh47muwzqN1tsmhAiFrvoKqCpna8\" 0.01 6 false \"donation\" \"seans outpost\"") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("sendfrom", "\"tabby\", \"AJw5Dqdh47muwzqN1tsmhAiFrvoKqCpna8\", 0.01, 6, false, \"donation\", \"seans outpost\"")
        );
...
UniValue sendmany(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 2 || params.size() > 8)
        throw runtime_error(
            ...
            "    {\n"
            "      \"address\":amount     (numeric or string) The arion address is the key, the numeric amount (can be string) in " + CURRENCY_UNIT + " is the value\n"
            "      ,...\n"
            "    }\n"
            ...
            "                           Those recipients will receive less arions than you enter in their corresponding amount field.\n"
            ...
            + HelpExampleCli("sendmany", "\"tabby\" \"{\\\"AJw5Dqdh47muwzqN1tsmhAiFrvoKqCpna8\\\":0.01,\\\"XuQQkwA4FYkq2XERzMY2CiAZhJTEDAbtcg\\\":0.02}\"") +
            "\nSend two amounts to two different addresses setting the confirmation and comment:\n"
            + HelpExampleCli("sendmany", "\"tabby\" \"{\\\"AJw5Dqdh47muwzqN1tsmhAiFrvoKqCpna8\\\":0.01,\\\"XuQQkwA4FYkq2XERzMY2CiAZhJTEDAbtcg\\\":0.02}\" 6 false \"testing\"") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("sendmany", "\"tabby\", \"{\\\"AJw5Dqdh47muwzqN1tsmhAiFrvoKqCpna8\\\":0.01,\\\"XuQQkwA4FYkq2XERzMY2CiAZhJTEDAbtcg\\\":0.02}\", 6, false, \"testing\"")
        );
    ...
    BOOST_FOREACH(const string& name_, keys)
    {
        ...
        if (!address.IsValid())
            throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, string("Invalid Arion address: ")+name_);
...
UniValue walletpassphrase(const UniValue& params, bool fHelp)
{
    ...
    if (pwalletMain->IsCrypted() && (fHelp || params.size() < 2 || params.size() > 3))
        throw runtime_error(
            ...
            "This is needed prior to performing transactions related to private keys such as sending arions\n"
            "\nArguments:\n"
...
UniValue walletlock(const UniValue& params, bool fHelp)
{
    ...
    if (pwalletMain->IsCrypted() && (fHelp || params.size() != 0))
        throw runtime_error(
            ...
            + HelpExampleCli("sendtoaddress", "\"AJw5Dqdh47muwzqN1tsmhAiFrvoKqCpna8\" 1.0") +
...
UniValue encryptwallet(const UniValue& params, bool fHelp)
{
    ...
    if (!pwalletMain->IsCrypted() && (fHelp || params.size() != 1))
        throw runtime_error(
            ...
            + HelpExampleCli("signmessage", "\"arionaddress\" \"test message\"") +
    ...
    StartShutdown();
    return "Wallet encrypted; Arion Core server stopping, restart to run with encrypted wallet. The keypool has been flushed and a new HD seed was generated (if you are using HD). You need to make a new backup.";
}
...
UniValue lockunspent(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            "A locked transaction output will not be chosen by automatic coin selection, when spending arions.\n"
...
UniValue listunspent(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 3)
        throw runtime_error(
            ...
            "3. \"addresses\"      (string) A json array of arion addresses to filter\n"
            "    [\n"
            "      \"address\"     (string) arion address\n"
            "      ,...\n"
            "    ]\n"
            "\nResult\n"
            ...
            "    \"vout\" : n,               (numeric) the vout value\n"
            "    \"address\" : \"address\",    (string) the arion address\n"
            ...
            "\nExamples\n"
            + HelpExampleCli("listunspent", "")
            + HelpExampleCli("listunspent", "6 9999999 \"[\\\"AJw5Dqdh47muwzqN1tsmhAiFrvoKqCpna8\\\",\\\"XuQQkwA4FYkq2XERzMY2CiAZhJTEDAbtcg\\\"]\"")
            + HelpExampleRpc("listunspent", "6, 9999999 \"[\\\"AJw5Dqdh47muwzqN1tsmhAiFrvoKqCpna8\\\",\\\"XuQQkwA4FYkq2XERzMY2CiAZhJTEDAbtcg\\\"]\"")
        );
