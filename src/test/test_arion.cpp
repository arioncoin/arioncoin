...
#define BOOST_TEST_MODULE Arion Test Suite

#include "test_arion.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_arion_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
