...
This mechanism has been integrated into Bitcore-Node-Arion which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/arionpay/insight-api-arion#web-socket-api](https://github.com/arionpay/insight-api-arion#web-socket-api)
* API: [https://github.com/arionpay/insight-api-arion#instantsend-transactions](https://github.com/arionpay/insight-api-arion#instantsend-transactions)
...
By default, the Arion Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Arion Core daemon:
