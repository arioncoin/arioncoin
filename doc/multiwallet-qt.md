...
Only requiring some minor changes is arion.cpp.
...
Changes to arion.cpp
----------------------
arion.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
